                    ...
                    data
                        ? <div className="flex flex-col gap-[70px]">
                            <div className="flex gap-10 items-center">
                                <h2 className="text-4xl font-medium">Hey ({data[0].name.length >= 20 ? data[0].name.slice(0, 20) + "..." : data[0].name}) 👋</h2>
                                <div className="flex gap-3 items-center">
                                    <div className="flex gap-3 px-4 h-[45px] justify-between items-center bg-blackToTrans border-primary rounded-20 hover:bg-white/5 transition cursor-pointer" onClick={() => setOpenAddMovieModal(true)}>
                                        <p className='text-4xl text-center'>+</p>
                                        <p className='text-sm text-center font-semibold'>List a Movie</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        : <div className="flex-1 flex flex-col justify-center items-center gap-14">
                            <div className='flex flex-col justify-center items-center gap-3'>
                                ...
                                <p className="text-lg text-center">If you're looking to book tickets, navigate to <Link className="underline" to="/search">search page</Link>.</p>
                            </div>
                            <Button
                                weight={"700"}
