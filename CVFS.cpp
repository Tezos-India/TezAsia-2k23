...
void man(char *name)
{
    ...
    else if(strcmp(name, "write") == 0)
    {
        ...
        printf("Usage : write File_name \n After this enter the data that you want ot write\n");
    }
...
int fstat_file(int fd)
{
    ...
    {
        printf("File Permission : Read and Write both \n");
    }
    printf("--------------------------------------------------------\n\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminatng My Virtual File System \n");
                break;
            }
            else
            {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"close") == 0)
            {
                ...
                if(ret == -1)
                {
                    printf("ERROR : Thers is no such file\n");
                }
                continue;
            }
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret == -1)
                {
                    printf("ERROR : Incorrect parametsers\n");
                }
