...
var DAppClient = /** @class */ (function (_super) {
    ...
    function DAppClient(config) {
        ...
        _this.preferredNetwork = (_e = config.preferredNetwork) !== null && _e !== void 0 ? _e : beacon_types_1.NetworkType.MAINNET;
        (0, beacon_ui_2.setColorMode)((_f = config.colorMode) !== null && _f !== void 0 ? _f : beacon_types_1.ColorMode.LIGHT);
        _this.disclaimerText = config.disclaimerText;
        _this.errorMessages = (_g = config.errorMessages) !== null && _g !== void 0 ? _g : {};
    ...
    DAppClient.prototype.requestPermissions = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var request, _a, message, connectionInfo, publicKey, address, walletKey, accountInfo, output, _b, _c;
            var _d, _e, _f;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this.getWalletInfo()];
                    case 8: return [4 /*yield*/, _b.apply(this, _c.concat([(_f.walletInfo = _g.sent(),
                                _f)]))];
                    case 9:
                        _g.sent();
