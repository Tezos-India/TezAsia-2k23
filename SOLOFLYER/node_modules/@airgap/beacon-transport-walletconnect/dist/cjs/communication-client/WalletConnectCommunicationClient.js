...
var WalletConnectCommunicationClient = /** @class */ (function (_super) {
    ...
    WalletConnectCommunicationClient.prototype.requestPermissions = function () {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var session, network, result, serializer, serialized;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        serializer = new beacon_core_1.Serializer();
                        return [4 /*yield*/, serializer.serialize({
                                type: beacon_types_1.BeaconMessageType.PermissionResponse,
                                appMetadata: {
                                    senderId: (_b = this.session) === null || _b === void 0 ? void 0 : _b.peer.publicKey,
                                    name: (_c = this.session) === null || _c === void 0 ? void 0 : _c.peer.metadata.name
                                },
                                publicKey: (_d = result[0]) === null || _d === void 0 ? void 0 : _d.pubkey,
    ...
    WalletConnectCommunicationClient.prototype.signPayload = function (signPayloadRequest) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var session, network, account, serializer, sendResponse;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        serializer = new beacon_core_1.Serializer();
                        sendResponse = function (response) { return __awaiter(_this, void 0, void 0, function () {
                            var serialized;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, serializer.serialize(response)];
                                    case 1:
                                        serialized = _a.sent();
                                        this.activeListeners.forEach(function (listener) {
                                            listener(serialized, {
