...
#import "./fa2/nft/NFT.mligo" "NFT"

(* An implementaion of FA2 Interface (TZIP-12) for a Single Asset Token *)
#import "./fa2/asset/single_asset.mligo" "SingleAsset"

(* An implementaion of FA2 Interface (TZIP-12) for a Multi Asset Token *)
#import "./fa2/asset/multi_asset.mligo" "MultiAsset"

(* An implementaion of Generic FA2 single asset *)
#import "./generic-fa2/single_asset/fa2.mligo" "Generic_SingleAsset"

(* An implementaion of Generic FA2 multi asset *)
#import "./generic-fa2/multi_asset/fa2.mligo" "Generic_MultiAsset"
